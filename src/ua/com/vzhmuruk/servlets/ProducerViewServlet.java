 ...
 */
@WebServlet(name = "ProducerViewServlet")
public class ProducerViewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>List of Producers</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            for (Producer prod : producerList) {
                ...
                out.println("<td><a href=\"producers?method=delete&id=" + prod.getId() + "\"><button>Delete</button></a></td>");
                out.println("</tr>");
            }
            out.println("</table><br>");
            out.println("<a href=\"create_producers.html\"><button>Create</button></a>");
